                            ...
                            <div className="col-lg-12">
                                <div className="position-relative newsletter-inner">
                                    <div className="newsletter-content">
                                        ...
                                        <p className="mb-45">Start You'r Daily Shopping with <span
                                            className="text-brand">Fresco Mart</span></p>
                        ...
                        <div className="row">
                            <div className="col">
                                <div className="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                                    <div className="logo mb-30">
                                        <a className='mb-15' href='/'><img src="/assets/imgs/theme/logo.svg"
                                                                                    alt="logo"/></a>
                                    ...
                                    <ul className="contact-infor">
                                        ...
                                        <li><img src="/assets/imgs/theme/icons/icon-email-2.svg"
                                                 alt=""/><strong>Email:</strong><span>sale@fresco.com</span></li>
                            ...
                            <div className="footer-link-widget col">
                                ...
                                <ul className="footer-list mb-sm-5 mb-md-0">
                                    ...
                                    <li><a href="/purchase-guide">Delivery Information</a></li>
                            ...
                            <div className="footer-link-widget col">
                                ...
                                <ul className="footer-list mb-sm-5 mb-md-0">
                                    ...
                                    <li><a href="/user/dashboard">Shipping Details</a></li>
                            ...
                            <div className="footer-link-widget widget-install-app col">
                                ...
                                <div className="download-app">
                                    <a href="#" className="hover-up mb-sm-2 mb-lg-0"><img className="active"
                                                                                          ...
                                                                                          alt=""/></a>
                                    <a href="#" className="hover-up mb-sm-2"><img
                                        src="/assets/imgs/theme/google-play.jpg" alt=""/></a>
                                </div>
                                <p className="mb-20">Secured Payment Gateways</p>
                                <img className="wow fadeIn animated" src="/assets/imgs/theme/payment-method.png"
                                     alt=""/>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container pb-30">
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6">
                            <p className="font-sm mb-0">&copy; 2024, <strong className="text-brand">Fresco</strong> - HTML
