                                        ...
                                        <div className="single-page pr-30 mb-lg-0 mb-sm-5">
                                            ...
                                            <div className="single-content mb-50">
                                                <p>Please read these Terms of Service (“Terms”, “Terms of Service”)
                                                    ...
                                                    operated by Evara (“us”, “we”, or “our”).</p>
                                                ...
                                                <ol>
                                                    ...
                                                    <li>Members are granted a time-limited, non-exclusive, revocable,
                                                        nontransferable, and non-sublicensable right to access that
                                                        portion of the online course corresponding to the purchase.
                                                    </li>
                                                    <li>The portion of the online course corresponding to the purchase
                                                    ...
                                                    <li>The videos in the course are provided as a video stream and are
                                                        not downloadable.
                                                    </li>
                                                    <li>By agreeing to grant such access, the Company does not obligate
                                                ...
                                                <p>Our Service may contain links to third-party web sites or services
                                                    that are not owned or controlled by Evara.</p>
                                                <p>Evara has no control over, and assumes no responsibility for, the
                                                ...
                                                <p>These Terms shall be governed and construed in accordance with the
                                                    laws of Viet Nam, without regard to its conflict of law
                                                    provisions.</p>
                                                <p>Our failure to enforce any right or provision of these Terms will not
                                                ...
                                                <p>If you have any questions about these Terms, please <a
                                                    href='page-contact.html'>contact us</a>.</p>
                                            </div>
                                        </div>
                                    </div>
