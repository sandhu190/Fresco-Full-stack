                        ...
                        <div className="row">
                            <div className="col-xl-10 col-lg-12 m-auto">
                                <section className="row align-items-center mb-50">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="pl-25">
                                            <h2 className="mb-30">Welcome to Fresco</h2>
                                            <p className="mb-25">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                                Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
                                                ut aliquip ex ea commodo consequat. Duis aute irure dolor in
                                                reprehenderit in voluptate id est laborum.</p>
                                            <p className="mb-50">Ius ferri velit sanctus cu, sed at soleat accusata.
                                                ...
                                                ornare lectus. Auctor elit sed vulputate mi sit amet. Commodo consequat.
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4 pr-30 mb-md-5 mb-lg-0 mb-sm-5">
                                            ...
                                            <p>Volutpat diam ut venenatis tellus in metus. Nec dui nunc mattis enim ut
                                                tellus eros donec ac odio orci ultrices in. ellus eros donec ac odio
                                                orci ultrices in.</p>
                                        </div>
                                        <div className="col-lg-4 pr-30 mb-md-5 mb-lg-0 mb-sm-5">
                                ...
                                <section className="mb-50">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
                                            ...
                                            <p className="mb-30">Proin ullamcorper pretium orci. Donec necscele risque
                                                leo. Nam massa dolor imperdiet neccon sequata congue idsem. Maecenas
